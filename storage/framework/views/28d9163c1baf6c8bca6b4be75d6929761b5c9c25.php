...
<div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label>Puesto:</label>
                <input type="text" name="puesto" id="puesto" class="form-control input-sm" placeholder="Puesto del empleado" value="<?php echo e(old('puesto', $empleado->puesto)); ?>">
            </div>
        </div>
</div>
<div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label>Edad: </label>
                <input type="number" name="edad" id="edad" class="form-control input-sm" placeholder="Edad del empleado" value="<?php echo e(old('edad', $empleado->edad)); ?>">
            </div>
        </div>
</div>
<div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select class="form-control" id="moneda" name="moneda">
                    <option value="<?php echo e(old('moneda', $empleado->moneda)); ?>"> <?php echo e(old('moneda', $empleado->moneda)); ?> </option>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control" id="estado" name="estado">
                <option value="<?php echo e(old('estado', $empleado->estado)); ?>"> <?php echo e(old('estado', $empleado->estado)); ?> </option>
